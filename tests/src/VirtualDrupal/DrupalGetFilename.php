...
class DrupalGetFilename {
  ...
  /**
   * Replicates backdrop_get_filename(*, *, $filename)
   *
   * @param string $type
   * @param string $name
   * @param string $filename
   */
  function backdropSetFilename($type, $name, $filename) {
  ...
  /**
   * Replicates backdrop_get_filename(*, *, NULL)
   *
   * @param string $type
   * @param string $name
   *
  ...
  function backdropGetPath($type, $name) {
    return dirname($this->backdropGetFilename($type, $name));
  }
} 
